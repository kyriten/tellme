                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">Branch Office</th>
                            <th scope="col" class="px-4 py-3">Department</th>
                            <th scope="col" class="px-4 py-3">Position</th>
                            <th scope="col" class="px-4 py-3">Verified on</th>
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row"
                                ...
                                kyriten</th>
                            <td class="px-4 py-3">Abimanyu Okysaptura R</td>
                            <td class="px-4 py-3">abimanyu@setiajaya.toyota.id</td>
                            <td class="px-4 py-3">Depok</td>
                            <td class="px-4 py-3">IT</td>
                            <td class="px-4 py-3">Web Programmer</td>
                            <td class="px-4 py-3">29/09/2023</td>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row"
                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                kyri</th>
                            <td class="px-4 py-3">k y r i</td>
                            <td class="px-4 py-3">kyri@setiajaya.toyota.id</td>
                            <td class="px-4 py-3">Bogor</td>
                            <td class="px-4 py-3">Administrasi</td>
                            <td class="px-4 py-3">Staf Admin</td>
                            <td class="px-4 py-3">29/09/2023</td>
                            <td class="px-4 py-3 flex items-center justify-end">
                ...
                <ul class="inline-flex items-stretch -space-x-px">
                    ...
                    <li>
                        <a href="#" aria-current="page"
                            class="flex items-center justify-center text-sm py-2 px-3 leading-tight text-red-600 bg-red-50 border border-red-300 hover:bg-red-100 hover:text-red-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">1</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center justify-center text-sm z-10 py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">3</a>
                    </li>
                    <li>
                        <a href="#"
