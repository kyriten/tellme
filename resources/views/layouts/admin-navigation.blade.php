            ...
            <nav class="flex-grow px-4 pb-4 md:block md:pb-0 md:overflow-y-auto"
                ...
                <div class="relative" @click.away="open = false" x-data="{ open: false }">
                    <button
                        ...
                        @click="open = !open">
                        <span>Dropdown</span>
                        <svg class="inline w-4 h-4 mt-1 ml-1 transition-transform duration-200 transform md:-mt-1"
                    ...
                    <div class="absolute right-0 w-full mt-2 origin-top-right rounded-md shadow-lg" x-show="open"
